...
async function playerOverview(id) {
  ...
  return normalizePlayerOverview(await getJson(`https://site.web.api.espn.com/apis/common/v3/sports/basketball/nba/athletes/${id}/overview`, 300_000));
}

module.exports = { scoreboard, summary, standings, teamsList, roster, injuries, transactions, playerOverview, normalizeEvent, normalizeSummary, normalizeStandings, normalizeTeams, normalizeRoster, normalizeInjuries, normalizeTransactions, normalizePlayerOverview };
